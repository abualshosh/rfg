package com.next.config.timezone;

import com.next.RfnclubApp;
import com.next.repository.timezone.DateTimeWrapper;
import com.next.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = RfnclubApp.class)
